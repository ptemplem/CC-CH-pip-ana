{
    ...
    gSystem->Load( gSystem->ExpandPathName("$TOPDIR/CC-CH-pip-ana/includes/libMAT.so") );
    gSystem->Load( gSystem->ExpandPathName("$TOPDIR/CC-CH-pip-ana/includes/libMAT-MINERvA.so") );
}